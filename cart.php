...
<div class="products">
    <div class="container">
        ...
        if (isset($_GET['did'])) {
            $did = $_GET['did'];
            $did = mysqli_query($connection, "delete from tbl_cart where cart_id = '{$_GET['did']}'");
        }
        echo "<h1 style='color:  #fe9126;'>Your Cart</h1>";
        $query = mysqli_query($connection, "select * from tbl_cart where user_id = '{$userid}'");
        ...
        if ($count > 0) {
            ...
            while ($data = mysqli_fetch_array($query)) {
                ...
                echo "<td><a href='cart.php?did={$data['cart_id']}'> Remove Product </a></td>";
                echo "</tr>";
            }
            echo "<tr><td></td><td></td><td></td><td></td><td>Total Purchase of: </td><td> $grandtotal </td></tr>";
            echo "</table>";
            echo "<br>";
            echo '<a href="checkout.php" style="color: #fe9126; text-decoration: none; font-weight: bold; padding: 5px 5px; background-color: white; border-radius: 0px; border: 2px solid #fe9126; margin: 5px 5px;">Check Out</a>';
        } else {
